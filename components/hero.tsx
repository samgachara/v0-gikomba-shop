            ...
            <div className="relative mx-auto w-full rounded-2xl">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  <div className="aspect-[3/4] rounded-2xl bg-card overflow-hidden shadow-lg relative">
                    <Image
                ...
                <div className="space-y-4 pt-8">
                  <div className="aspect-square rounded-2xl bg-card overflow-hidden shadow-lg relative">
                    <Image
