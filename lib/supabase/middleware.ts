...
export async function updateSession(request: NextRequest) {
  ...
  const supabaseKey = (process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY?.startsWith('eyJ') && process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY?.includes('ecrttmokkmaqdlsxhlvv') ? process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY : 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVjcnR0bW9ra21hcWRsc3hobHZ2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzMyMTU2MzAsImV4cCI6MjA4ODc5MTYzMH0.cb8SIczUHH3a6hytKZsFCuQF1qEKT7CIbuoUScrgAE0')
